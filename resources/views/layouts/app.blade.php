...
<head>
    ...
    <!--Page Loader-->
    @vite(['resources/css/page_loader.css', 'resources/js/page_loader.js'])
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('employee-project.*') ? 'active' : '' }}"  href="{{ route('employee-project.index') }}">Works On</a>
                        </li>
                    </ul>
